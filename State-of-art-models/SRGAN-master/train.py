...
def evaluate():
    ...
    # Print the shape and type of loaded images
    # print(f"Loaded {len(valid_hr_imgs)} validation images.")
    # for img in valid_hr_imgs[:5]:
    ...
    for imid, valid_hr_img in enumerate(valid_hr_imgs):
        ...
        # print(f"Processing image {imid + 1}/{len(valid_hr_imgs)}")
        # print("validation lr image type:", type(valid_lr_img))
        # print("validation lr image shape:", valid_lr_img.shape)
        # print("validation hr image type:", type(valid_hr_img))
        # print("validation hr image shape:", valid_hr_img.shape)

        hr_size1 = [valid_lr_img.shape[0], valid_lr_img.shape[1]]
        # print("hr_size1:", hr_size1)
