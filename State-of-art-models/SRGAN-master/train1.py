...
# ## check executing directory
# import sys
# print(sys.executable)
# print()

# ## check tensorflow availability and compatibility
# import tensorflow as tf
...
# ## check tensorlayer avaibality and compatability

# try:
#     import tensorlayerx as tlx
#     print("TensorLayer is available")
# except ImportError:
#     print("TensorLayer is not available")

# import os

# hr_img_path = os.path.abspath('/home/oshadi/SISR-Final_Year_Project/envs/SISR-Project/data/DIV2K/DIV2K_train_HR/')
# print(f"Checking path: {hr_img_path}")
# if not os.path.exists(hr_img_path):
#     print("Path does not exist...")
# else:
#     print("Path exists!")
#     print("Contents of the directory:")
#     print(os.listdir(hr_img_path))
# print("HYYYYYYYY....")
...
lr_transform = Resize(size=(96, 96)) # Adjusted resize size
...
def evaluate():
    ...
    # Ensure valid_lr_img is a NumPy array with the correct data type
    ...
    if valid_lr_img.dtype != np.uint8:
        ...
        print("This is executed... valid_lr_img.dtype != np.uint8:")
    ...
    # Ensure valid_hr_img is a NumPy array with the correct data type
    ...
    if valid_hr_img.dtype != np.uint8:
        ...
        print("This is executed as second... valid_lr_img.dtype != np.uint8:")
    
    tlx.vision.save_image(out, file_name='valid_gen1.png', path=save_dir)
    tlx.vision.save_image(valid_lr_img, file_name='valid_lr1.png', path=save_dir)
    tlx.vision.save_image(valid_hr_img, file_name='valid_hr1.png', path=save_dir)
    out_bicu = cv2.resize(valid_lr_img, dsize = [size[1] * 4, size[0] * 4], interpolation = cv2.INTER_CUBIC)
    tlx.vision.save_image(out_bicu, file_name='valid_hr_cubic1.png', path=save_dir)
