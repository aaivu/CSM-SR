...
parser.add_argument('--model_denoiser', default='/home/oshadi/SISR-Final_Year_Project/envs/SISR-Project/State-of-art-models/dSRVAE-master/dSRVAE-master/models/VAE_epoch_5000.pth', help='pretrained denoising model')
# parser.add_argument('--model_SR', default='models/VAE_SR.pth', help='pretrained SR model')
parser.add_argument('--model_SR', default='/home/oshadi/SISR-Final_Year_Project/envs/SISR-Project/State-of-art-models/dSRVAE-master/dSRVAE-master/models/GAN_generator_1000.pth', help='pretrained SR model')
