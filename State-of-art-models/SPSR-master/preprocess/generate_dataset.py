...
#     dataDir = '/home/oshadi/SISR-Final_Year_Project/envs/SISR-Project/State-of-art-models/SRGAN-master/DIV2K/DIV2K_train_HR' # original dataset path
#     saveDir = '/home/oshadi/SISR-Final_Year_Project/envs/SISR-Project/State-of-art-models/SPSR-master/data/dataset' # path to save results
...
if __name__ == "__main__":
    dataDirTr = '/home/oshadi/SISR-Final_Year_Project/envs/SISR-Project/data/DIV2K/DIV2K_train_HR' # original dataset path
    saveDirTr = '/home/oshadi/SISR-Final_Year_Project/envs/SISR-Project/State-of-art-models/SPSR-master/data/Tdataset' # path to save results
    dataDirV = '/home/oshadi/SISR-Final_Year_Project/envs/SISR-Project/data/DIV2K/DIV2K_valid_HR' # original dataset path
    saveDirV = '/home/oshadi/SISR-Final_Year_Project/envs/SISR-Project/State-of-art-models/SPSR-master/data/Vdataset' # path to save results
    
    
    scale = '4' # up sample scale and picture size scale
    if not os.path.isdir(saveDirTr):
        os.mkdir(saveDirTr)
    for dirs in os.listdir(dataDirTr):
        print('Datasets:', dirs)
        GenerateMod(dataDirTr, saveDirTr, scale)
